...
static unsigned long restart_timer;
static unsigned long restart_delay;
...
#else
        if ((exhaust_temp > flame_threshold) && (seconds >=120)) { // exhaust temp greater than threshold meaning fire has started.
